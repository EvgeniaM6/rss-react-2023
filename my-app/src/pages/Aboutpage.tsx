...
export class Aboutpage extends Component<TPropsHandle> {
  componentDidMount(): void {
    this.props.handleOpenPage(PAGES.about);
  }
    ...
    return (
      <div className="container about-page">
        ...
        <p className="about-page__paragraph">
          Stylish is an online shopping club where you can buy clothes, shoes, bags and accessories
        ...
        <p className="about-page__paragraph">
          ...
          trends, tastes and needs of Ukrainian buyers and, most importantly, know how to provide
        ...
        <p className="about-page__paragraph">
          ...
          Internet is simple, fast and cheap. We are constantly working to ensure that Stylish is
        ...
        <p className="about-page__paragraph">
          The Stylish platform is the meeting point for merchants. Today, the platform cooperates
          with more than 5,000 partners and plans to increase the volume of cooperation in order to
          constantly expand and improve the range, offer more new products with an acceptable
          pricing policy.
        </p>
      </div>
    );
